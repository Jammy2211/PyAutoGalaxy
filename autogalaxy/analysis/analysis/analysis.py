...
class Analysis(af.Analysis):
    ...
    def profile_log_likelihood_function(
        ...
        try:
            ...
            info_dict["sub_size_light_profiles"] = self.dataset.grid.over_sample.sub_size
        ...
        if fit.model_obj.has(cls=aa.Pixelization):
            ...
            try:
                info_dict["sub_size_pixelization"] = self.dataset.grid_pixelization.over_sample.sub_size
            except AttributeError:
                pass
            info_dict[
