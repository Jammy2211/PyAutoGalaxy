...
- https://github.com/lenstronomy/lenstronomy/blob/main/lenstronomy/LensModel/Profiles/epl.py
- https://github.com/lenstronomy/lenstronomy/blob/main/lenstronomy/Util/param_util.py
- https://github.com/lenstronomy/lenstronomy/blob/main/lenstronomy/Util/util.py

The function derivatives_q_phi() has been added, for practicality.
...
class EPLEuclid(MassProfile):
    ...
    def deflections_yx_2d_from(self, grid, **kwargs):
        ...
        deflections_x, deflections_y = profile.derivatives_q_phi(
                x,
            y,
...
class EPL(object):
    ...
    def function(self, x, y, theta_E, gamma, e1, e2, center_x=0, center_y=0):
        ...
        y_ = y - center_y
        # rotate
        x__, y__ = rotate(x_, y_, phi_G)
        # evaluate
        f_ = self.epl_major_axis.function(x__, y__, b, t, q)
        # rotate back
        return f_

    def derivatives_q_phi(self, x, y, theta_E, gamma, q, phi, center_x=0, center_y=0):
        """
        ...
        return self.derivatives(x, y, theta_E, gamma, e1, e2, center_x=center_x, center_y=center_y)
