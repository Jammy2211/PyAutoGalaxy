...
class ResultQuantity(ResultDataset):
    """
    After the non-linear search of a fit to an imaging dataset is complete it creates this `ResultQuantity`, object
    which includes:
    ...
    `FitQuantity`, hyper-galaxy images,etc.
