...
def test__hyper_search():
    ...
    setup = ag.legacy.SetupHyper(search_pix_cls=None, search_pix_dict=None)
    ...
    setup = ag.legacy.SetupHyper(search_noise_cls=None, search_noise_dict=None)
