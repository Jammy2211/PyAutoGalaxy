...
def test__scale_sky_in_image__increases_all_image_values():
    ...
    scaled_image = hyper_sky.hyper_image_from(image=image)
...
def test__scaled_background_noise__adds_to_input_noise():
    ...
    hyper_noise_map = hyper_background_noise_map.hyper_noise_map_from(
        noise_map=noise_map
    )

    assert (hyper_noise_map == np.array([3.0, 4.0, 5.0])).all()

    hyper_noise_map_background = ag.legacy.hyper_data.HyperBackgroundNoise(
        noise_scale=3.0
    )

    scaled_noise = hyper_noise_map_background.hyper_noise_map_from(noise_map=noise_map)
...
def test__scaled_background_noise__adds_to_input_noise__uses_complex_if_input_is_complex():
    ...
    hyper_noise_map = hyper_background_noise_map.hyper_noise_map_complex_from(
        noise_map=noise_map
    )
    ...
    scaled_noise = hyper_noise_map_background.hyper_noise_map_complex_from(
        noise_map=noise_map
    )
