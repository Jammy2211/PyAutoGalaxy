...
def test__fit_imaging_randomly_drawn_via_pdf_gen_from__analysis_has_single_dataset(
    ...
    for fit_imaging_gen in fit_imaging_pdf_gen:
        for fit_imaging_list in fit_imaging_gen:
            i += 1

            assert fit_imaging_list[0].plane.galaxies[0].redshift == 0.5
            assert fit_imaging_list[0].plane.galaxies[0].light.centre == (10.0, 10.0)
...
def test__fit_imaging_randomly_drawn_via_pdf_gen_from__analysis_multi(
    ...
    for fit_imaging_gen in fit_imaging_pdf_gen:
        for fit_imaging_list in fit_imaging_gen:
            ...
            assert fit_imaging_list[1].plane.galaxies[0].redshift == 0.5
            assert fit_imaging_list[1].plane.galaxies[0].light.centre == (10.0, 10.0)
