...
def test__image_2d_from(sub_grid_2d_7x7, gal_x1_lp):
    ...
    image = galaxies.image_2d_from(grid=sub_grid_2d_7x7)
...
def test__image_2d_list_from(sub_grid_2d_7x7):
    ...
    image_of_galaxies = galaxies.image_2d_list_from(grid=sub_grid_2d_7x7)
...
def test__image_2d_from__operated_only_input(sub_grid_2d_7x7, lp_0, lp_operated_0):
    ...
    image_2d = galaxies.image_2d_from(grid=sub_grid_2d_7x7, operated_only=False)
    assert image_2d == pytest.approx(image_2d_not_operated, 1.0e-4)

    image_2d = galaxies.image_2d_from(grid=sub_grid_2d_7x7, operated_only=True)
    assert image_2d == pytest.approx(3.0 * image_2d_operated, 1.0e-4)

    image_2d = galaxies.image_2d_from(grid=sub_grid_2d_7x7, operated_only=None)
...
def test__galaxy_image_2d_dict_from(sub_grid_2d_7x7):
    ...
    galaxy_image_2d_dict = galaxies.galaxy_image_2d_dict_from(grid=sub_grid_2d_7x7)
...
def test__convergence_2d_from(sub_grid_2d_7x7):
    ...
    convergence = galaxies.convergence_2d_from(grid=sub_grid_2d_7x7)
...
def test__potential_2d_from(sub_grid_2d_7x7):
    ...
    potential = galaxies.potential_2d_from(grid=sub_grid_2d_7x7)
...
def test__deflections_yx_2d_from(sub_grid_2d_7x7):
    ...
    deflections = galaxies.deflections_yx_2d_from(grid=sub_grid_2d_7x7)
