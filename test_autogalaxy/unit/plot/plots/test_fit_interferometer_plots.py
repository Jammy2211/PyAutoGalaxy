...
def test__fit_sub_plot(masked_interferometer_fit_7x7, plot_path, plot_patch):

    aplt.FitInterferometer.subplot_fit_interferometer(
        fit=masked_interferometer_fit_7x7,
        plotter_1d=aplt.Plotter1D(output=aplt.Output(plot_path, format="png")),
    )
...
def test__fit_sub_plot_real_space(
    masked_interferometer_fit_7x7, include_2d_all, plot_path, plot_patch
):
