...
def test__get_visuals_2d(lp_0, grid_2d_7x7):
    ...
    assert light_profile_plotter.get_visuals_2d().origin.in_list == [(0.0, 0.0)]
    assert (light_profile_plotter.get_visuals_2d().mask == grid_2d_7x7.mask).all()
    assert (
        light_profile_plotter.get_visuals_2d().border
        == grid_2d_7x7.mask.border_grid_sub_1.binned
    ).all()
    assert light_profile_plotter.get_visuals_2d().light_profile_centres.in_list == [
        lp_0.centre
    ]
    assert light_profile_plotter.get_visuals_2d().vector_field == 2
    ...
    assert light_profile_plotter.get_visuals_2d().origin == None
    assert light_profile_plotter.get_visuals_2d().mask == None
    assert light_profile_plotter.get_visuals_2d().border == None
    assert light_profile_plotter.get_visuals_2d().vector_field == 2
