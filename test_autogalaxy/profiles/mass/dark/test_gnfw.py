...
def test__deflections_yx_2d_from():
    ...
    deflections = gnfw.deflections_yx_2d_from(grid=ag.Grid2DIrregular([[1.0, 0.0]]))
    deflections_via_mge = gnfw.deflections_2d_via_mge_from(
...
def test__convergence_2d_via_mge_from():
    ...
    convergence = gnfw.convergence_2d_via_mge_from(
...
def test__convergence_2d_from():
    ...
    convergence = gnfw.convergence_2d_from(grid=ag.Grid2DIrregular([[2.0, 0.0]]))
...
def test__potential_2d_from():
    ...
    potential = gnfw.potential_2d_from(grid=ag.Grid2DIrregular([[0.1625, 0.1875]]))
