...
def test__potential_2d_from():
    ...
    potential = shear.potential_2d_from(grid=ag.Grid2DIrregular([[0.1, 0.1]]))
...
def test__convergence_returns_zeros():
    shear = ag.mp.ExternalShear(gamma_1=0.0, gamma_2=0.1)
    convergence = shear.convergence_2d_from(grid=ag.Grid2DIrregular([[0.1, 0.1]]))
    ...
    convergence = shear.convergence_2d_from(grid=ag.Grid2DIrregular([[1.0, 0.0]]))
