...
def test__convergence_2d_from():
    ...
    convergence = exponential.convergence_2d_from(grid=ag.Grid2DIrregular([[1.0, 0.0]]))
    ...
    convergence = exponential.convergence_2d_from(grid=ag.Grid2DIrregular([[0.0, 1.0]]))
