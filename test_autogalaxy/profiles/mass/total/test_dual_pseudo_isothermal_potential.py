...
def test__deflections_yx_2d_from():
    mp = ag.mp.dPIEPSph(centre=(-0.7, 0.5), b0=5.2, ra=2.0, rs=3.0)
    ...
    mp = ag.mp.dPIEPSph(centre=(-0.1, 0.1), b0=20.0, ra=2.0, rs=3.0)
    ...
    mp = ag.mp.dPIEP(centre=(0, 0), ell_comps=(0.0, 0.333333), b0=4.0, ra=2.0, rs=3.0)
    ...
    elliptical = ag.mp.dPIEP(
        centre=(1.1, 1.1), ell_comps=(0.0, 0.0), b0=12.0, ra=2.0, rs=3.0
    )
    spherical = ag.mp.dPIEPSph(centre=(1.1, 1.1), b0=12.0, ra=2.0, rs=3.0)
...
def test__convergence_2d_from():
    ...
    mp = ag.mp.dPIEPSph(centre=(0.0, 0.0), b0=8.0, ra=2.0, rs=3.0)

    convergence = mp.convergence_2d_from(grid=ag.Grid2DIrregular([[0.0, 1.0]]))

    assert convergence == pytest.approx(1.57182995, 1e-3)

    mp = ag.mp.dPIEP(centre=(0.0, 0.0), ell_comps=(0.0, 0.0), b0=4.0, ra=2.0, rs=3.0)

    convergence = mp.convergence_2d_from(grid=ag.Grid2DIrregular([[0.0, 1.0]]))

    assert convergence == pytest.approx(0.78591498, 1e-3)

    mp = ag.mp.dPIEP(centre=(0.0, 0.0), ell_comps=(0.0, 0.0), b0=8.0, ra=2.0, rs=3.0)
