...
def test__image_2d_from():
    ...
    image = exponential.image_2d_from(grid=ag.Grid2DIrregular([[1.0, 0.0]]))
    ...
    image = exponential.image_2d_from(grid=ag.Grid2DIrregular([[0.0, 1.0]]))
    ...
    value = exponential.image_2d_from(grid=ag.Grid2DIrregular([[0.0, 1.0]]))
