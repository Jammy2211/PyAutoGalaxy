...
class TestEllGaussian:
    def test__deflections_correct_values(self):
        ...
        deflections = gaussian.deflections_2d_from_grid(grid=np.array([[1.0, 0.0]]))
        ...
        deflections = gaussian.deflections_2d_from_grid(grid=np.array([[0.5, 0.2]]))
    ...
    def test__deflections_via_integrator_and_analytic_agree(self):
        ...
        deflections_via_analytic = gaussian.deflections_2d_from_grid(grid=grid)
        deflections_via_integrator = gaussian.deflections_2d_from_grid_via_integrator(
            grid=grid
        )
    ...
    def test__intensity_and_convergence_match_for_mass_light_ratio_1(self):
        ...
        intensity = gaussian_light_profile.image_2d_from_grid(
            grid=np.array([[1.0, 0.0]])
        )
        convergence = gaussian_mass_profile.convergence_2d_from_grid(
            grid=np.array([[1.0, 0.0]])
        )
    ...
    def test__image_2d_from_grid_radii__correct_value(self):
        ...
        intensity = gaussian.image_2d_from_grid_radii(grid_radii=1.0)
        ...
        intensity = gaussian.image_2d_from_grid_radii(grid_radii=3.0)

        assert intensity == pytest.approx(0.32465, 1e-2)

    def test__convergence_2d_from_grid__correct_value(self):
        gaussian = ag.mp.EllGaussian(
            centre=(0.0, 0.0),
        ...
        convergence = gaussian.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
...
class TestSersic:
    def test__convergence_correct_values(self):
        ...
        convergence = sersic.convergence_2d_from_grid(grid=np.array([[0.0, 1.5]]))
        ...
        convergence = sersic.convergence_2d_from_grid(grid=np.array([[1.0, 0.0]]))

        assert convergence == pytest.approx(5.38066670129, 1e-3)

    def test__convergence_2d_from_grid_gaussians__correct_values(self):
        sersic = ag.mp.EllSersic(
            centre=(0.0, 0.0),
            intensity=3.0,
            effective_radius=2.0,
        ...
        convergence = sersic.convergence_2d_from_grid_via_gaussians(
    ...
    def test__deflections_via_integrator__correct_values(self):
        ...
        deflections = sersic.deflections_2d_from_grid_via_integrator(
    ...
    def test__deflections_2d_from_grid_close_to_integrator__correct_values(self):
        ...
        deflections = sersic.deflections_2d_from_grid(grid=np.array([[0.1625, 0.1625]]))
        ...
        deflections = sersic.deflections_2d_from_grid(
            grid=ag.Grid2DIrregular([(0.1625, 0.1625), (0.1625, 0.1625)])
        )
    ...
    def test__convergence__change_geometry(self):
        ...
        convergence_0 = sersic_0.convergence_2d_from_grid(grid=np.array([[1.0, 1.0]]))

        convergence_1 = sersic_1.convergence_2d_from_grid(grid=np.array([[0.0, 0.0]]))
        ...
        convergence_0 = sersic_0.convergence_2d_from_grid(grid=np.array([[1.0, 0.0]]))

        convergence_1 = sersic_1.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
    ...
    def test__deflections__change_geometry(self):
        ...
        deflections_0 = sersic_0.deflections_2d_from_grid(grid=np.array([[1.0, 1.0]]))
        deflections_1 = sersic_1.deflections_2d_from_grid(grid=np.array([[0.0, 0.0]]))
        ...
        deflections_0 = sersic_0.deflections_2d_from_grid(grid=np.array([[1.0, 0.0]]))
        deflections_1 = sersic_1.deflections_2d_from_grid(grid=np.array([[0.0, 1.0]]))
    ...
    def test__spherical_and_elliptical_identical(self):
        ...
        assert (
            elliptical.convergence_2d_from_grid(grid=grid)
            == spherical.convergence_2d_from_grid(grid=grid)
        ).all()
        # assert elliptical.potential_2d_from_grid(grid=grid) == spherical.potential_2d_from_grid(grid=grid)
        np.testing.assert_almost_equal(
            elliptical.deflections_2d_from_grid_via_integrator(grid=grid),
            spherical.deflections_2d_from_grid_via_integrator(grid=grid),
        )
    ...
    def test__outputs_are_autoarrays(self):
        ...
        convergence = sersic.convergence_2d_from_grid(grid=grid)

        assert convergence.shape_native == (2, 2)

        # potential = sersic.potential_2d_from_grid(
        #     grid=grid)
        #
        # assert potential.shape == (2, 2)

        deflections = sersic.deflections_2d_from_grid_via_integrator(grid=grid)
...
class TestExponential:
    def test__convergence_correct_values(self):
        ...
        convergence = exponential.convergence_2d_from_grid(grid=np.array([[1.0, 0.0]]))
        ...
        convergence = exponential.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
    ...
    def test__convergence_2d_from_grid_via_gaussians__correct_values(self):
        exponential = ag.mp.EllExponential(
            elliptical_comps=(0.0, 0.333333),
            intensity=3.0,
            effective_radius=2.0,
        ...
        convergence = exponential.convergence_2d_from_grid_via_gaussians(
            grid=np.array([[1.0, 0.0]])
        )
    ...
    def test__deflections_via_integrator__correct_values(self):
        ...
        deflections = exponential.deflections_2d_from_grid_via_integrator(
            grid=np.array([[0.1625, 0.1625]])
        )
    ...
    def test__deflections_2d_from_grid_close_to_integrator_correct_values(self):
        exponential = ag.mp.EllExponential(
            centre=(-0.4, -0.2),
            elliptical_comps=(-0.07142, -0.085116),
            intensity=5.0,
        ...
        deflections = exponential.deflections_2d_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
    ...
    def test__outputs_are_autoarrays(self):
        ...
        convergence = exponential.convergence_2d_from_grid(grid=grid)

        assert convergence.shape_native == (2, 2)

        # potential = exponential.potential_2d_from_grid(
        #     grid=grid)
        #
        # assert potential.shape == (2, 2)

        deflections = exponential.deflections_2d_from_grid_via_integrator(grid=grid)
...
class TestDevVaucouleurs:
    def test__convergence_correct_values(self):
        ...
        convergence = dev.convergence_2d_from_grid(grid=np.array([[1.0, 0.0]]))
        ...
        convergence = dev.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
    ...
    def test__convergence_2d_from_grid_via_gaussians__correct_values(self):
        ...
        convergence = dev.convergence_2d_from_grid_via_gaussians(
            grid=np.array([[1.0, 0.0]])
        )
    ...
    def test__deflections_via_integrator__correct_values(self):
        ...
        deflections = dev.deflections_2d_from_grid_via_integrator(
            grid=ag.Grid2DIrregular([(0.1625, 0.1625)])
        )
    ...
    def test__deflections_2d_from_grid_close_to_integrator__correct_values(self):
        ...
        deflections = dev.deflections_2d_from_grid(
            grid=ag.Grid2DIrregular([(0.1625, 0.1625)])
        )
    ...
    def test__outputs_are_autoarrays(self):
        ...
        convergence = dev_vaucouleurs.convergence_2d_from_grid(grid=grid)

        assert convergence.shape_native == (2, 2)

        # potential = dev_vaucouleurs.potential_2d_from_grid(
        #     grid=grid)
        #
        # assert potential.shape == (2, 2)

        deflections = dev_vaucouleurs.deflections_2d_from_grid_via_integrator(grid=grid)
...
class TestSersicMassRadialGradient:
    def test__convergence_correct_values(self):
        ...
        convergence = sersic.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
        ...
        convergence = sersic.convergence_2d_from_grid(grid=np.array([[1.5, 0.0]]))
    ...
    def test__deflections_2d_from_grid_using_mge__same_as_integrator__correct_values(
        self
    ):
    ...
    def test__compare_to_sersic(self):
        ...
        sersic_deflections = sersic.deflections_2d_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
        ...
        exponential_deflections = exponential.deflections_2d_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
        ...
        dev_deflections = dev.deflections_2d_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
        ...
        sersic_grad_deflections = sersic_grad.deflections_2d_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
    ...
    def test__outputs_are_autoarrays(self):
        ...
        deflections = sersic.deflections_2d_from_grid(grid=grid)
...
class TestSersicCore:
    def test__convergence_correct_values(self):
        ...
        convergence = core_sersic.convergence_2d_from_grid(grid=np.array([[0.0, 0.01]]))
    ...
    def test__convergence_2d_from_grid_via_gaussians__same_as_convergence_2d_from_grid(
        self
    ):
        ...
        convergence = core_sersic.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
        convergence_via_gaussians = core_sersic.convergence_2d_from_grid_via_gaussians(
            grid=np.array([[0.0, 1.0]])
        )

        assert convergence == pytest.approx(convergence_via_gaussians, 1e-3)

    def test__deflections_2d_from_grid__correct_values(self):
        ...
        deflections = sersic.deflections_2d_from_grid(grid=np.array([[2.5, -2.5]]))
...
class TestChameleon:
    def test__convergence_correct_values(self):
        ...
        convergence = chameleon.convergence_2d_from_grid(grid=np.array([[0.0, 1.0]]))
        ...
        convergence = chameleon.convergence_2d_from_grid(grid=np.array([[0.0, 1.5]]))
    ...
    def test__deflections_correct_values(self):
        ...
        deflections = chameleon.deflections_2d_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
    ...
    def test__convergence__change_geometry(self):
        ...
        convergence_0 = chameleon_0.convergence_2d_from_grid(
            grid=np.array([[1.0, 1.0]])
        )

        convergence_1 = chameleon_1.convergence_2d_from_grid(
    ...
    def test__deflections__change_geometry(self):
        ...
        deflections_0 = chameleon_0.deflections_2d_from_grid(
            grid=np.array([[1.0, 1.0]])
        )
        deflections_1 = chameleon_1.deflections_2d_from_grid(
            grid=np.array([[0.0, 0.0]])
        )
    ...
    def test__outputs_are_autoarrays(self):
        ...
        convergence = chameleon.convergence_2d_from_grid(grid=grid)

        assert convergence.shape_native == (2, 2)

        # potential = chameleon.potential_2d_from_grid(
        #     grid=grid)
        #
        # assert potential.shape == (2, 2)

        deflections = chameleon.deflections_2d_from_grid(grid=grid)
