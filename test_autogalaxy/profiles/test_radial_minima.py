...
def test__grid_2d__moves_radial_coordinates__does_not_double_transform():
    ...
    convergence_1 = isothermal.convergence_2d_from_grid(grid=grid_2d)
    convergence_0 = isothermal.convergence_2d_from_grid(grid=grid_2d_offset)
...
def test__grid_2d_irrergular__moves_radial_coordinates__does_not_double_transform():
    ...
    convergence_1 = isothermal.convergence_2d_from_grid(grid=grid_2d_irregular)
    convergence_0 = isothermal.convergence_2d_from_grid(grid=grid_2d_irregular_offset)
