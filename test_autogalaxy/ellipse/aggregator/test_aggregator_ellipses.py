...
#
#             if i == 1:
#                 assert ellipse_list[0].g0.redshift == 0.5
#                 assert ellipse_list[0].g0.light.centre == (1.0, 1.0)
#                 assert ellipse_list[0].g1.redshift == 1.0
#
#             if i == 2:
#                 assert ellipse_list[0].g0.redshift == 0.5
#                 assert ellipse_list[0].g0.light.centre == (10.0, 10.0)
#                 assert ellipse_list[0].g1.redshift == 1.0
#
