...
def test__simulator__via_galaxies_from__data_matches_via_image():
...
def test__simulator__via_galaxies_from__uv_wavelengths_match_via_image():
    grid = ag.Grid2D.uniform(shape_native=(20, 20), pixel_scales=0.05)
...
def test__simulator__simulate_from_source_galaxy__data_matches_via_image():
    galaxy_0 = ag.Galaxy(
        redshift=0.5,
...
def test__simulator__simulate_from_source_galaxy__uv_wavelengths_match_via_image():
    galaxy_0 = ag.Galaxy(
        redshift=0.5,
        mass=ag.mp.Isothermal(
            centre=(0.0, 0.0), einstein_radius=1.6, ell_comps=(0.17647, 0.0)
...
def test__simulator__simulate_from_source_galaxy__noise_map_matches_via_image():
    galaxy_0 = ag.Galaxy(
        redshift=0.5,
        mass=ag.mp.Isothermal(
            centre=(0.0, 0.0), einstein_radius=1.6, ell_comps=(0.17647, 0.0)
