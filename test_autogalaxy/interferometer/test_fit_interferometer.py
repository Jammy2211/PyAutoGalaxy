...
def test___galaxy_model_image_dict(interferometer_7):
    ...
    mapper_grids = pixelization.mesh.mapper_grids_from(
        ...
        border_relocator=interferometer_7.mapper_tools.border_relocator,
        source_plane_mesh_grid=None
    )

    mapper = ag.Mapper(
        mapper_grids=mapper_grids, mapper_tools=interferometer_7.mapper_tools, regularization=pixelization.regularization
    )
