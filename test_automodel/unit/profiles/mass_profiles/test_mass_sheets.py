...
class TestMassSheet(object):
    ...
    def test__convergence__correct_values(self):
        mass_sheet = am.mass_profiles.MassSheet(centre=(0.0, 0.0), kappa=1.0)
        ...
        mass_sheet = am.mass_profiles.MassSheet(centre=(0.0, 0.0), kappa=-3.0)
    ...
    def test__deflections__correct_values(self):
        ...
        mass_sheet = am.mass_profiles.MassSheet(centre=(0.0, 0.0), kappa=2.0)
        ...
        mass_sheet = am.mass_profiles.MassSheet(centre=(1.0, 2.0), kappa=1.0)
    ...
    def test__deflections__change_geometry(self):
        mass_sheet_0 = am.mass_profiles.MassSheet(centre=(0.0, 0.0))
        mass_sheet_1 = am.mass_profiles.MassSheet(centre=(1.0, 1.0))
        ...
        mass_sheet_0 = am.mass_profiles.MassSheet(centre=(0.0, 0.0))
        mass_sheet_1 = am.mass_profiles.MassSheet(centre=(0.0, 0.0))
    ...
    def test__reshape_decorators(self):
        ...
        mass_sheet = am.mass_profiles.MassSheet()
...
class TestExternalShear(object):
    def test__constructor_and_units(self):
        ...
        shear = am.mass_profiles.ExternalShear(magnitude=0.05, phi=45.0)
    ...
    def test__deflections_correct_values(self):
        ...
        shear = am.mass_profiles.ExternalShear(magnitude=0.2, phi=75.0)
        deflections = shear.deflections_from_grid(grid=np.array([[0.1625, 0.1625]]))
