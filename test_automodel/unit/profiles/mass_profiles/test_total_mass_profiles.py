...
class TestPointMass(object):
    ...
    def test__deflections__correct_values(self):
        ...
        point_mass = am.mass_profiles.PointMass(centre=(0.0, 0.0), einstein_radius=1.0)
        ...
        point_mass = am.mass_profiles.PointMass(centre=(0.0, 0.0), einstein_radius=2.0)
        ...
        point_mass = am.mass_profiles.PointMass(centre=(1.0, 2.0), einstein_radius=1.0)
    ...
    def test__deflections__change_geometry(self):
        ...
        point_mass_0 = am.mass_profiles.PointMass(centre=(0.0, 0.0))
        point_mass_1 = am.mass_profiles.PointMass(centre=(1.0, 1.0))
        ...
        point_mass_0 = am.mass_profiles.PointMass(centre=(0.0, 0.0))
        point_mass_1 = am.mass_profiles.PointMass(centre=(0.0, 0.0))
    ...
    def test__deflections_of_profile__dont_use_interpolate_and_cache_decorators(self):
        point_mass = am.mass_profiles.PointMass(centre=(-0.3, 0.2), einstein_radius=1.0)
    ...
    # def test__mass(self):
    #
    #     point_mass = am.mass_profiles.PointMass(centre=(0.0, 0.0), einstein_radius=1.91716)
    #
    ...
    def test__reshape_decorators(self):
        ...
        point_mass = am.mass_profiles.PointMass()
...
class TestCoredPowerLaw(object):
    def test__constructor_and_units(self):
        cored_power_law = am.mass_profiles.EllipticalCoredPowerLaw(
            centre=(1.0, 2.0),
            axis_ratio=0.5,
            phi=45.0,
            einstein_radius=1.0,
        ...
        cored_power_law = am.mass_profiles.SphericalCoredPowerLaw(
    ...
    def test__potential_correct_values(self):
        power_law = am.mass_profiles.SphericalCoredPowerLaw(
    ...
    def test__surfce_density__change_geometry(self):
        cored_power_law_0 = am.mass_profiles.SphericalCoredPowerLaw(centre=(0.0, 0.0))
        cored_power_law_1 = am.mass_profiles.SphericalCoredPowerLaw(centre=(1.0, 1.0))
        ...
        cored_power_law_0 = am.mass_profiles.SphericalCoredPowerLaw(centre=(0.0, 0.0))
        cored_power_law_1 = am.mass_profiles.SphericalCoredPowerLaw(centre=(0.0, 0.0))
        assert cored_power_law_0.convergence_from_grid(
            grid=np.array([[1.0, 0.0]])
        ) == cored_power_law_1.convergence_from_grid(grid=np.array([[0.0, 1.0]]))

        cored_power_law_0 = am.mass_profiles.EllipticalCoredPowerLaw(
            centre=(0.0, 0.0), axis_ratio=0.8, phi=0.0
        )
        cored_power_law_1 = am.mass_profiles.EllipticalCoredPowerLaw(
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = am.mass_profiles.EllipticalCoredPowerLaw(
            centre=(1.1, 1.1),
            axis_ratio=1.0,
            phi=0.0,
            einstein_radius=3.0,
        ...
        spherical = am.mass_profiles.SphericalCoredPowerLaw(
            centre=(1.1, 1.1), einstein_radius=3.0, slope=2.2, core_radius=0.1
        )

        assert ellipticam.convergence_from_grid(grid=grid) == pytest.approx(
            sphericam.convergence_from_grid(grid=grid), 1e-4
        )
        assert ellipticam.potential_from_grid(grid=grid) == pytest.approx(
            sphericam.potential_from_grid(grid=grid), 1e-4
        )
        assert ellipticam.deflections_from_grid(grid=grid) == pytest.approx(
            sphericam.deflections_from_grid(grid=grid), 1e-4
        )
...
class TestPowerLaw(object):
    def test__constructor_and_units(self):
        power_law = am.mass_profiles.EllipticalPowerLaw(
        ...
        power_law = am.mass_profiles.SphericalPowerLaw(
    ...
    def test__convergence_correct_values(self):
        isothermal = am.mass_profiles.SphericalPowerLaw(
            centre=(0.0, 0.0), einstein_radius=1.0, slope=2.0
        )
        assert isothermam.convergence_from_grid(
            grid=np.array([[1.0, 0.0]])
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = am.mass_profiles.EllipticalPowerLaw(
            centre=(1.1, 1.1),
            axis_ratio=0.9999,
            phi=0.0,
            einstein_radius=3.0,
        ...
        spherical = am.mass_profiles.SphericalPowerLaw(
...
class TestCoredIsothermal(object):
    def test__constructor_and_units(self):
        cored_isothermal = am.mass_profiles.EllipticalCoredIsothermal(
            centre=(1.0, 2.0),
            axis_ratio=0.5,
            phi=45.0,
            einstein_radius=1.0,
        ...
        assert cored_isothermam.axis_ratio == 0.5
        assert isinstance(cored_isothermam.axis_ratio, float)

        assert cored_isothermam.phi == 45.0
        ...
        cored_isothermal = am.mass_profiles.SphericalCoredIsothermal(
        ...
        assert cored_isothermam.axis_ratio == 1.0
        assert isinstance(cored_isothermam.axis_ratio, float)

        assert cored_isothermam.phi == 0.0
        assert isinstance(cored_isothermam.phi, float)
    ...
    def test__convergence_correct_values(self):
        ...
        assert cored_isothermam.convergence_func(radius=1.0) == pytest.approx(
            0.49752, 1e-4
        )
        ...
        assert cored_isothermam.convergence_from_grid(
            grid=np.array([[1.0, 0.0]])
    ...
    def test__potential__correct_values(self):
        isothermal_core = am.mass_profiles.SphericalCoredIsothermal(
        ...
        assert cored_isothermam.potential_from_grid(
            grid=np.array([[0.1625, 0.1625]])
    ...
    def test__deflections__correct_values(self):
        ...
        deflections = cored_isothermam.deflections_from_grid(
            grid=np.array([[0.1625, 0.1625]])
        )
    ...
    def test__compare_to_cored_power_law(self):
        power_law = am.mass_profiles.EllipticalCoredIsothermal(
            centre=(0.0, 0.0),
            axis_ratio=0.5,
            phi=45.0,
            einstein_radius=1.0,
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = am.mass_profiles.EllipticalCoredIsothermal(
            centre=(1.1, 1.1),
            axis_ratio=0.9999,
            phi=0.0,
            einstein_radius=3.0,
        ...
        spherical = am.mass_profiles.SphericalCoredIsothermal(
    ...
    def test__deflections_of_elliptical_profile__use_interpolate_and_cache_decorators(
        ...
        interp_deflections = cored_isothermam.deflections_from_grid(
            grid=regular_with_interp
        )
        interpolator = am.Interpolator.from_mask_grid_and_pixel_scale_interpolation_grids(
            mask=mask, grid=grid, pixel_scale_interpolation_grid=0.5
        ...
        interp_deflections_values = cored_isothermam.deflections_from_grid(
            grid=interpolator.interp_grid
        )
    ...
    def test__reshape_decorators(self):
        ...
        convergence = cored_isothermam.convergence_from_grid(grid=grid)
...
class TestIsothermal(object):
    def test__constructor_and_units(self):
        isothermal = am.mass_profiles.EllipticalIsothermal(
        ...
        assert isothermam.axis_ratio == 0.5
        assert isinstance(isothermam.axis_ratio, float)

        assert isothermam.phi == 45.0
        ...
        isothermal = am.mass_profiles.SphericalIsothermal(
        ...
        assert isothermam.axis_ratio == 1.0
        assert isinstance(isothermam.axis_ratio, float)

        assert isothermam.phi == 0.0
        assert isinstance(isothermam.phi, float)
    ...
    def test__potential__correct_values(self):
        ...
        assert isothermam.potential_from_grid(
            grid=np.array([[0.1875, 0.1625]])
    ...
    def test__deflections__correct_values(self):
        ...
        deflections = isothermam.deflections_from_grid(
            grid=np.array([[0.1875, 0.1625]])
        )
    ...
    def test__compare_to_cored_power_law(self):
        ...
        assert isothermam.potential_from_grid(grid=grid) == pytest.approx(
            cored_power_law.potential_from_grid(grid=grid), 1e-3
        )
        assert isothermam.potential_from_grid(grid=grid) == pytest.approx(
            cored_power_law.potential_from_grid(grid=grid), 1e-3
        )
        assert isothermam.deflections_from_grid(grid=grid) == pytest.approx(
            cored_power_law.deflections_from_grid(grid=grid), 1e-3
        )
        assert isothermam.deflections_from_grid(grid=grid) == pytest.approx(
            cored_power_law.deflections_from_grid(grid=grid), 1e-3
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = am.mass_profiles.EllipticalIsothermal(
            centre=(1.1, 1.1), axis_ratio=0.9999, phi=0.0, einstein_radius=3.0
        )
        spherical = am.mass_profiles.SphericalIsothermal(
    ...
    def test__radius_of_critical_curve(self):
        sis = am.mass_profiles.SphericalIsothermal(
            centre=(0.0, 0.0), einstein_radius=2.0
        )
    ...
    def test__deflections_of_elliptical_profile__dont_use_interpolate_and_cache_decorators(
        ...
        interp_deflections = isothermam.deflections_from_grid(grid=regular_with_interp)
        interpolator = am.Interpolator.from_mask_grid_and_pixel_scale_interpolation_grids(
            mask=mask, grid=grid, pixel_scale_interpolation_grid=0.5
        )

        interp_deflections_values = isothermam.deflections_from_grid(
            grid=interpolator.interp_grid
        )
    ...
    def test__reshape_decorators(self):
        ...
        convergence = isothermam.convergence_from_grid(grid=grid)
