...
def test__label_and_label_string():
    string0 = am.util.text.label_and_label_string(
        label0="param0", label1="mass", whitespace=10
    )
    string1 = am.util.text.label_and_label_string(
        label0="param00", label1="mass0", whitespace=10
    )
    string2 = am.util.text.label_and_label_string(
...
def test__label_and_value_string():
    ...
    string1 = am.util.text.label_and_value_string(
        label="param00", value=2.0, whitespace=10
    )
    string2 = am.util.text.label_and_value_string(
    ...
    string = am.util.text.label_and_value_string(
...
def test__label_value_and_limits_string():
    string0 = am.util.text.label_value_and_limits_string(
        label="param0", value=2.0, upper_limit=2.5, lower_limit=1.5, whitespace=10
    )
    string1 = am.util.text.label_value_and_limits_string(
        label="param00", value=2.0, upper_limit=2.7, lower_limit=1.3, whitespace=10
    )
    string2 = am.util.text.label_value_and_limits_string(
    ...
    string = am.util.text.label_value_and_limits_string(
        label="param11",
        value=3.00,
        upper_limit=40000.0,
        lower_limit=0.0001,
...
def test__label_value_and_unit_string():
    string0 = am.util.text.label_value_and_unit_string(
        label="param0", value=2.0, unit="arcsec", whitespace=10
    )
    string1 = am.util.text.label_value_and_unit_string(
        label="param00", value=2.0, unit="mass", whitespace=10
    )
    string2 = am.util.text.label_value_and_unit_string(
    ...
    string = am.util.text.label_value_and_unit_string(
...
def test__output_list_of_strings_to_file():
    ...
    results = ["hi\n", "hello"]
    am.util.text.output_list_of_strings_to_file(
...
def test__within_radius_label_value_and_unit_string():
    string0 = am.util.text.within_radius_label_value_and_unit_string(
        prefix="mass",
        radius=1.0,
        unit_length="arcsec",
        value=30.0,
    ...
    string1 = am.util.text.within_radius_label_value_and_unit_string(
        prefix="mass",
        radius=1.0,
        unit_length="arcsec",
        value=30.0,
    ...
    string2 = am.util.text.within_radius_label_value_and_unit_string(
        prefix="mass",
        radius=1.0,
        unit_length="arcsec",
        value=30.0,
    ...
    string = am.util.text.within_radius_label_value_and_unit_string(
        prefix="mass",
        radius=1.0,
        unit_length="arcsec2",
        value=40.0,
...
def test_string():
    assert am.util.text.format_string_for_label("radius_value") == "radius_value"
    assert am.util.text.format_string_for_label("mass_value") == "mass_value"

def test_substring():
    assert am.util.text.format_string_for_label("einstein_radius_value") == "radius_value"
    assert am.util.text.format_string_for_label("mass_value_something") == "mass_value"