...
**PyAutoLens** provides tool for simulating strong galaxy data-sets, which can be used to test galaxy modeling pipelines
and train neural networks to recognise and analyse images of strong galaxyes.

Simulating strong galaxyes begins by creating a *SimulatorImaging* object, which represents how a image is acquired and
...
The **autogalaxy_workspace** includes example simulators for various existing and upcoming telescopes, for example the
