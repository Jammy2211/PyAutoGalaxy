...
class TestUnits:
    ...
    def test__galaxy_keeps_attributes(self):
        ...
        galaxy = aast.galaxy(light_0=profile_0, redshift=1.0, pixelization=1, regularization=2)
    ...
    class TestSymmetricProfiles(object):
        def test_1d_symmetry(self):
            ...
            assert gal_x2_lp.profile_image_from_grid(
                ...
                grid=aa.grid.manual_2d([[[100.0, 0.0]]])
            )
            assert gal_x2_lp.profile_image_from_grid(
                grid=aa.grid.manual_2d([[[49.0, 0.0]]])
            ) == gal_x2_lp.profile_image_from_grid(
                grid=aa.grid.manual_2d([[[51.0, 0.0]]])
            )
        ...
        def test_2d_symmetry(self):
            ...
            assert gal_x4_lp.profile_image_from_grid(
                ...
                gal_x4_lp.profile_image_from_grid(
                    grid=aa.grid.manual_2d([[[0.0, 51.0]]])
                ),
                1e-5,
            )
            ...
            assert gal_x4_lp.profile_image_from_grid(
                ...
                gal_x4_lp.profile_image_from_grid(
                    grid=aa.grid.manual_2d([[[100.0, 51.0]]])
                ),
                1e-5,
            )
            ...
            assert gal_x4_lp.profile_image_from_grid(
                ...
                gal_x4_lp.profile_image_from_grid(
                    grid=aa.grid.manual_2d([[[51.0, 51.0]]])
                ),
                1e-5,
            )
...
class TestMassProfiles(object):
    ...
    class TestSymmetricProfiles:
        def test_1d_symmetry(self):
            ...
            assert gal_x4_mp.convergence_from_grid(
                ...
                grid=aa.grid.manual_2d([[[99.0, 0.0]]])
            )
            ...
            assert gal_x4_mp.potential_from_grid(
                ...
                gal_x4_mp.potential_from_grid(grid=aa.grid.manual_2d([[[99.0, 0.0]]])),
                1e-6,
            )
            ...
            assert gal_x4_mp.potential_from_grid(
                ...
                gal_x4_mp.potential_from_grid(grid=aa.grid.manual_2d([[[51.0, 0.0]]])),
                1e-6,
            )
        ...
        def test_2d_symmetry(self):
            ...
            assert gal_x4_mp.potential_from_grid(
                ...
                gal_x4_mp.potential_from_grid(grid=aa.grid.manual_2d([[[0.0, 51.0]]])),
                1e-5,
            )
            ...
            assert gal_x4_mp.potential_from_grid(
                ...
                gal_x4_mp.potential_from_grid(grid=aa.grid.manual_2d([[[51.0, 51.0]]])),
                1e-5,
            )
    ...
    class TestMassProfileGeometry:
        ...
        def test__extracts_centres_correctly(self):
            ...
            galaxy = aast.galaxy(redshift=0.5, mp_0=aast.mp.EllipticalMassProfile(centre=(0.0, 1.0)))
        ...
        def test__extracts_axis_ratio_correctly(self):
            ...
            galaxy = aast.galaxy(redshift=0.5, mp_0=aast.mp.EllipticalMassProfile(axis_ratio=0.9))
        ...
        def test__extracts_phis_correctly(self):
            ...
            galaxy = aast.galaxy(redshift=0.5, mp_0=aast.mp.EllipticalMassProfile(phi=0.9))
    ...
    class TestLensingObject(object):
        ...
        def test__correct_einstein_mass_caclulated_for_multiple_mass_profiles__means_all_innherited_methods_work(self, convergence_grid_config):
            ...
            sis_1 = aast.mp.SphericalIsothermal(
